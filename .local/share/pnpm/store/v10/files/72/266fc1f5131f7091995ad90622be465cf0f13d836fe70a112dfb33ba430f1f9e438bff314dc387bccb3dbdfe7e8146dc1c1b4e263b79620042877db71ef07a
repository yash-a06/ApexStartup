...
const require_versionSelector = require('./versionSelector-D1CeFW5f.js');
...
const clerkUIScriptUrl = (opts) => {
	...
	const version = require_versionSelector.versionSelector(__internal_clerkUIVersion, "1.6.9");
